...
from .views import home_view, desk_view, admin_manage_view, generate_points, generate_ko_points, info_view, user_puntuation, generate_points_by_groups, admin_table_view
